...
.PHONY: help test coverage htmlcoverage docs devrepl codestyle check-changelog changelog reuse paper clean distclean
.DEFAULT_GOAL := help
...
clean:  ## Clean up build/doc/testing artifacts
	...
	rm -f docs/LocalPreferences.toml test/LocalPreferences.toml
